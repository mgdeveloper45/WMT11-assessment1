...
// CODE HERE
/* traverse over the full length of the 3 acres arrays 
   sum up their totals and store the total in total Acres variable
*/
let totalAcres = 0;
...
// CODE HERE
/* calculated the average number of acres picked per day
   by dividing the totalAcres by the total number of days
   and stored its total in averageDailyAcres variable
*/
...
/*  using a while loop calculated the the number days
    to harvest acresLeft by subtracting the averageDailyAcres
    on each iteration adding 1 to days until acresLeft is zero  
*/
let acresLeft = 174; 
let days = 0;
...
/* traverse through the length of the 3 acres arrays multiplied
    it's values by 6.5 and push it's totals into the 3 empty tons arrays
*/
// CODE HERE
...
/*  traverse through the 3 tons arrays multiplied its values by 2000 lbs
    and sum up its totals in the 3 lbs variables
*/
let fujiLbs = 0;  
let galaLbs = 0;
let pinkLbs = 0;
...
for(let i = 0; i < fujiTons.length; i++) {
    fujiLbs += (fujiTons[i] * 2000);
    galaLbs += (galaTons[i] * 2000);
    pinkLbs += (pinkTons[i] * 2000);
}
console.log(`${fujiLbs} lbs, ${galaLbs} lbs, ${pinkLbs} lbs`)
...
/*  multiplied total lbs by the price and store total 3 variables 
*/
const fujiPrice = .89 
const galaPrice = .64
const pinkPrice = .55
...
let fujiProfit = fujiLbs * fujiPrice;
let galaProfit = galaLbs * galaPrice;
let pinkProfit = pinkLbs * pinkPrice;
...
/* sum up the 3 total prices and stored the sum into totalProfit variable
*/
// CODE HERE
